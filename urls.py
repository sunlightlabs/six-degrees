...
urlpatterns = patterns('',
    ...
    url(r'^existing-identifiers/$', direct_to_template, {'template': 'existing_identifiers.html'}, name='existing-identifiers'),
    url(r'^singapore-uen/$', direct_to_template, {'template': 'singapore_uen.html'}, name='singapore-uen'),
